...
- CHANGING NUCLEAR REACTION SOURCES / REFERENCES
  ...
  1. Charged particle reactions computed by analytic formula in VITAL module. However, once 'T' is switched to 'F', NACRE(netgen module) and REACLIB(reaclib moodule) are being adopted .
