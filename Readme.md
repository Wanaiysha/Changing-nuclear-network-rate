...
By default, the code sets up the network as follows:
   ...
   **However, if 'T' is switched to 'F', the NACRE table or (Illiadis (2001) table for proton-capture on 20 < A < 40 nuclei) is being interpolated following the netgen module.
